                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="p-4 flex items-center justify-between">
                        ...
                        <Link to="/recruiter/jobs/new">
                            <button
                                className="flex items-center justify-center bg-white rounded-3xl text-red-500 font-medium transition-colors hover:bg-red-50 hover:text-red-600 hover:border-red-300 border border-red-500 px-3 py-2"
                            >
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <div className="flex space-x-2 w-full">
                            <Link className='w-1/2' to="/recruiter/jobs">
                                <button
                            ...
                            <Link className='w-1/2' to="/recruiter/jobs/drafts">
                                <button
