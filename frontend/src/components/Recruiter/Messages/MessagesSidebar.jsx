    ...
    return (
        <div className="relative flex h-screen pb-16">
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <div className="flex space-x-2">
                            ...
                            <button
                                ...
                                className={`flex-1 px-4 py-2 rounded-full text-sm font-medium transition-colors ${'ss' === 'drafts'
                                    ? 'bg-red-500 text-white'
                                    : 'bg-[#F3E4E2] border border-red-600 text-gray-70'
                                    }`}
                            >
                                Archived
                            </button>
                        ...
                        {recentChats?.length > 0 ? (
                            recentChats.map((chat) => (
                                <div
                                    ...
                                    className={`p-3 border-l-4 mr-4 ${chat._id === receiver ? 'border-[#EA4C25] bg-white' : 'border-transparent'} hover:bg-gray-50 cursor-pointer transition-colors`}
                                >
            ...
            {/* Overlay for mobile */}
            {
                isSidebarOpen && (
                    <div
                        className="md:hidden fixed inset-0 bg-black bg-opacity-50 z-2s0"
